                        ...
                        <table class="mt-3 w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                ...
                                <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                    ...
                                    <td class="px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ $lesson->created_at->toFormattedDateString() }}
                                    </td>
                                    <td class="px-6 py-4">
                                        <a class="inline" href="{{ route('lessons.show', $lesson) }}">
                                        ...
                                        <form class="inline" method="POST" action="{{ route('lessons.destroy', $lesson) }}">
                                            ...
                                            <button onClick="alert('Are you sure you want delete this lesson?')" type="submit">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 inline">
